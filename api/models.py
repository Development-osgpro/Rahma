...
class Program(models.Model):
    ...
    region = models.ForeignKey(Region, on_delete=models.PROTECT)
    mainImg = models.ImageField(upload_to='Program/', default="Program/default.jpg")
...
class Hero(models.Model):
    ...
    service_image = models.FileField(upload_to='Hero/', validators=[validate_file_extension])
